...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bind_param("issssssssss", $user_id, $user_type, $time_type, $comment, $excuse_startdate, $excuse_enddate, $number_of_days, $return_on, $supporting_document, $excuse_status, $date_filed);
