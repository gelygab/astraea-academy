...
<body>
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <h3>MAIN MENU</h3>
               <a href="studentdashboardHOME.html"><span class="material-symbols-outlined">star</span><h2>Home</h2></a>
        ...
        <main class="student-dashboard">
            <section class="card student-card">
                ...
                <div class="student-info-flex">
                    ...
                    <div class="info-details">
                        ...
                        <div id="studentDetailsGrid" class="details-grid"></div>
                    </div>
                </div>
            ...
            <div class="main-grid-layout">
                <div class="left-column">
                    ...
                    <section class="card small-card class-days">
                        <h3>Class Days</h3>
                        <p>Class days for Monthly</p>
                    </section>
                    </div>
                    <div class="left-column-2">
                    <section class="card attendance-rate-card">
                        <h3>Attendance Rate</h3>
                        <div class="tag">This Year</div>
                        <hr>
                        <h3>Monthly Rate</h3>
                    </section>
                    </div>
